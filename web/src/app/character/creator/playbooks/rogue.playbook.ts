...
export const rogue: Playbook = {
  ...
  description: 'PLACEHOLDER description for The Rogue.',
  ...
  movesAdvice: 'PLACEHOLDER moves advice for The Rogue.',
  ...
  // PLACEHOLDER — suggested connection prompts for The Rogue.
  connectionPrompts: ['PLACEHOLDER connection prompt for The Rogue.', 'PLACEHOLDER connection prompt for The Rogue.'],
